---
name: tm-maps-hellas
description: Hellas-map-specific strategy for Terraforming Mars — south pole ocean ring, placement patterns, map-specific milestones. Load when a game is on the Hellas map.
---
