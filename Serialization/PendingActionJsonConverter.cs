...
public class PendingActionJsonConverter : JsonConverter<PendingAction>
{
        ...
        bool hasExistingValue, JsonSerializer serializer)
    {
        ...
        return type switch
        {
            ...
            "RemoveCardResource" => obj.ToObject<RemoveCardResourcePending>(CreateInnerSerializer(serializer)),
            "DrawKeep" => obj.ToObject<DrawKeepPending>(CreateInnerSerializer(serializer)),
            ...
            "CopyProduction" => obj.ToObject<CopyProductionPending>(CreateInnerSerializer(serializer)),
            "MarsUniversity" => obj.ToObject<MarsUniversityPending>(CreateInnerSerializer(serializer)),
            "ChooseTriggerOrder" => obj.ToObject<ChooseTriggerOrderPending>(CreateInnerSerializer(serializer)),
    ...
    public override void WriteJson(JsonWriter writer, PendingAction? value, JsonSerializer serializer)
    {
        ...
        var typeName = value switch
        {
            ...
            RemoveCardResourcePending => "RemoveCardResource",
            DrawKeepPending => "DrawKeep",
            ...
            CopyProductionPending => "CopyProduction",
            MarsUniversityPending => "MarsUniversity",
            ChooseTriggerOrderPending => "ChooseTriggerOrder",
            SetupPending => "Setup",
