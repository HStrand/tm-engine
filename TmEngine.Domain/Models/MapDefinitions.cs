...
public sealed record MapDefinition(
    ...
    int MaxOxygen = Constants.DefaultMaxOxygen,
    int MaxTemperature = Constants.DefaultMaxTemperature,
    int MaxOceans = Constants.DefaultMaxOceans);
...
public static class MapDefinitions
{
    ...
    private static MapDefinition BuildTharsis()
    {
        ...
        // Placement bonuses per hex (from board image). Every hex is listed explicitly.
        var bonuses = new Dictionary<HexCoord, PlacementBonus[]>
        {
            // Row 1:
            [new(3, 1)] = [PlacementBonus.Steel, PlacementBonus.Steel],
            [new(4, 1)] = [PlacementBonus.Steel, PlacementBonus.Steel],  // ocean
            [new(5, 1)] = [],
            ...
            // Row 2:
            [new(3, 2)] = [],
            [new(4, 2)] = [PlacementBonus.Steel], // Tharsis Tholus
            [new(5, 2)] = [],
            [new(6, 2)] = [],
            [new(7, 2)] = [],
            [new(8, 2)] = [PlacementBonus.Cards, PlacementBonus.Cards],  // ocean

            // Row 3:
            [new(2, 3)] = [PlacementBonus.Cards], // Ascraeus Mons
            [new(3, 3)] = [],
            [new(4, 3)] = [],
            [new(5, 3)] = [],
            [new(6, 3)] = [],
            ...
            // Row 4:
            [new(2, 4)] = [PlacementBonus.Plants, PlacementBonus.Titanium], // Pavonis Mons
            [new(3, 4)] = [PlacementBonus.Plants],
            [new(4, 4)] = [PlacementBonus.Plants,],
            [new(5, 4)] = [PlacementBonus.Plants],
            [new(6, 4)] = [PlacementBonus.Plants, PlacementBonus.Plants],
            [new(7, 4)] = [PlacementBonus.Plants],
            [new(8, 4)] = [PlacementBonus.Plants],
            [new(9, 4)] = [PlacementBonus.Plants, PlacementBonus.Plants], // ocean

            // Row 5: Valles Marineris
            [new(1, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants], // Arsia Mons
            [new(2, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants],
            [new(3, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants], // Noctis City
            [new(4, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants], // ocean
            [new(5, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants], // ocean
            [new(6, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants], // ocean
            [new(7, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants],
            [new(8, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants],
            [new(9, 5)] = [PlacementBonus.Plants, PlacementBonus.Plants],

            // Row 6:
            [new(2, 6)] = [PlacementBonus.Plants],
            [new(3, 6)] = [PlacementBonus.Plants, PlacementBonus.Plants],
            [new(4, 6)] = [PlacementBonus.Plants],
            [new(5, 6)] = [PlacementBonus.Plants],
            [new(6, 6)] = [PlacementBonus.Plants],
            [new(7, 6)] = [PlacementBonus.Plants], // ocean
            [new(8, 6)] = [PlacementBonus.Plants], // ocean
            [new(9, 6)] = [PlacementBonus.Plants], // ocean
            ...
            [new(5, 7)] = [],
            [new(6, 7)] = [],
            [new(7, 7)] = [PlacementBonus.Plants],
            [new(8, 7)] = [],

            // Row 8:
            [new(3, 8)] = [PlacementBonus.Steel, PlacementBonus.Steel],
            [new(4, 8)] = [],
            [new(5, 8)] = [PlacementBonus.Cards],
            [new(6, 8)] = [PlacementBonus.Cards],
            [new(7, 8)] = [],
            [new(8, 8)] = [PlacementBonus.Titanium],

            // Row 9:
            [new(3, 9)] = [PlacementBonus.Steel],
            [new(4, 9)] = [PlacementBonus.Steel, PlacementBonus.Steel],
            [new(5, 9)] = [],
            [new(6, 9)] = [],
            [new(7, 9)] = [PlacementBonus.Titanium, PlacementBonus.Titanium], // ocean
        };
