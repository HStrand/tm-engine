...
public static class CardRegistry
{
    ...
    private static void RegisterProjectCardEffects(ImmutableDictionary<string, CardEntry>.Builder builder)
    {
        ...
        SetEffects(builder, "031",
            ongoingEffects: [
                new WhenYouEffect(TriggerCondition.PlaySpaceEventTag, new ChangeResourceEffect(ResourceType.MegaCredits, 3)),
                new WhenYouEffect(TriggerCondition.PlaySpaceEventTag, new ChangeResourceEffect(ResourceType.Heat, 3)),
            ]);
